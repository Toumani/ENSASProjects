...
<html lang="en">
	...
	<head>
		...
		<title>SCRUManager | Welcome !</title>
		...
		<div class="">
			...
			<div id="wrapper">
				...
				<section class="login_content">
					...
					<div>
						<input style="margin: auto;float: initial;" class="btn btn-default submit" type="submit" value="Submit" />
					...
					<div class="separator">
						...
						<br />
						<div>
						<h1><i class="fa fa-paw" style="font-size: 26px;"></i> SCRUManager</h1>
